...
constexpr const char* const FIRSTNAME = "karol";
constexpr const char* const SURNAME   = "kowalczyk";
constexpr const char* const MAIL    = "bolekbolek909@gmail.com";
constexpr const char* const BOOK_ID = "417047";
...
int main()
{
    ...
    /// @todo: Prosze o odpowiednie implementacje:
