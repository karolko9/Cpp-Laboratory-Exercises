...
public:
    ...
    TwoDimensionMatrix();
    TwoDimensionMatrix(TwoDimensionMatrix const &matrix);
    TwoDimensionMatrix(const MatrixElement matrix[size_][size_]);
    static constexpr int size(){
        return size_;
    }
    MatrixElement get(size_t row, size_t col) const {
    ...
    friend std::ostream& operator<<(std::ostream& os, const TwoDimensionMatrix& mat);
    friend std::istream& operator>>(std::istream& is, TwoDimensionMatrix& mat);
